  ...
  class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      ...
      */
      ...
      $consulta = 'select idUsuarios, nombreusuario, rolusuario_idrolusuario from usuarios where nombreusuario="'.$user.'" and password="'.$clave.'"';
      /*
      ...
      */
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        $_SESSION['rol']  = $user['rolusuario_idrolusuario'];
