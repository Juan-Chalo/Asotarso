                 ...
                 <?php
                       ...
                       $documento="";
						...
						if(isset($_POST["Submit"])){
                            ...
                            $rutafinal="reporteFinancieroSocios"."/".$filename;

                            if (move_uploaded_file($ruta, $rutafinal)) {
                                
                                $documento=$rutafinal;
                            }
                        $res="INSERT INTO reporte (descripcion, reporte, fecha, Estado_idEstado) VALUES ('$descripcion', '$documento', NOW(), '$estado')";
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Agregar Reporte Financiero Socios
                            </h2>
                        </div>
                        <div class="body">
