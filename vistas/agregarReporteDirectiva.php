    ...
    <div class="container-fluid">
                 ...
                 <?php
                       ...
                       $documento="";
                        ...
                        $res="INSERT INTO reporte_directiva (descripcion, reporte, fecha, Estado_idEstado) VALUES ('$descripcion', '$documento', NOW(), '$estado')";
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Agregar Reporte Financiero Directiva
                            </h2>
                        </div>
                        <div class="body">
                          <form method="post"  enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                ...
                                <a href="finanzasDirectiva.php" class="btn btn-danger waves-effect">Cancelar</a>
                            </form>
                        </div>
                    </div>
                </div>
