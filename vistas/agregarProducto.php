                        ...
                        <div class="body">
                          <form method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="codigo" name="codigo" class="form-control" placeholder="Ingrese el codigo del producto">
                                    </div>
                                </div>
                                <label for="email_address">Nombre del Producto</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="tex" id="nombreProducto" name="nameProducto" class="form-control" placeholder="Ingrese el nombre del producto">
                                    </div>
                                </div>

                                 <label for="email_address">Precio del Producto</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="tex" id="precioProducto" name="precioProducto" class="form-control" placeholder="Ingrese el precio del producto">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="tex" id="existencia" name="existencia" class="form-control" placeholder="Ingrese el precio del producto">
                                    </div>
                                </div>

                                   <label for="password">Categorias de Producto</label>
                                  <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                	<?php
